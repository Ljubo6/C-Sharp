...
ALTER TABLE People
ADD CONSTRAINT CH_People CHECK (DATALENGTH(Picture) > 1024 * 1024 * 2)

ALTER TABLE People
ADD CONSTRAINT CH_Gender_People CHECK(Gender = 'f' OR Gender = 'm')
...
INSERT INTO Directors (DirectoryName,Notes) VALUES
